# Memory Banks — AI Assistant Navigation Guide

Welcome to the memory banks for **task-board-lab**. This directory serves as the centralized knowledge base for AI assistants working on this project. Use the sections below to find the information you need quickly.
...
**Start with:** [coding-standards.md](./conventions/coding-standards.md)
...
**Start with:** [glossary.md](./domain/glossary.md)
...
**Start with:** [development-process.md](./workflows/development-process.md)
...
1. **New to the project?** Start with [Architecture Overview](./architecture/overview.md) and [Domain Glossary](./domain/glossary.md)
2. **Writing code?** Check [Coding Standards](./conventions/coding-standards.md) and relevant sections in **Workflows**
3. **Reviewing code?** See **Conventions** and **Workflows** for standards and checklists
4. **Role-specific context?** Navigate to the **Roles** section for your position
...
- Ensure all files are markdown (.md) format
